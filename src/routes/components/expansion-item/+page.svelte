...
<QDocs {snippets} componentDocs={QExpansionItemDocs}>
  {#snippet usage()}
    <QDocsSection title="Basic">
      ...
      <QList bordered separator>
        <QExpansionItem label="Click me" icon="waving_hand">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia aliquid facere, dolorem
            iusto amet quas ad nesciunt, error molestias nostrum quisquam unde a minima molestiae
            natus omnis nulla magni exercitationem.
          </p>
        </QExpansionItem>
        <QExpansionItem
        ...
        >
          <p>
            ...
            velit magni similique porro laborum temporibus excepturi, nobis, alias numquam molestiae
            eaque, unde qui accusantium ullam reiciendis facilis!
          </p>
        </QExpansionItem>
      </QList>
    </QDocsSection>
    ...
    <QDocsSection title="With name group (accordion)">
      ...
      <QList bordered separator>
        <QExpansionItem label="First section" icon="folder" name="group1">
          <p>
            This is the first section of the accordion. When you expand another item in this group,
            this one will automatically close.
          </p>
        </QExpansionItem>
        <QExpansionItem
    ...
    <QDocsSection title="Expand icon toggle">
      {#snippet sectionDescription()}
        Use <code>expandIconToggle</code> to make only the expand icon clickable, while the rest of the
        header can be used for navigation or other actions.
      {/snippet}
    ...
    <QDocsSection title="Custom summary with complex layouts">
      {#snippet sectionDescription()}
        Use the <code>summary</code> snippet to completely customize the header layout. The snippet
        receives an object with <code>expanded</code> state and control functions.
      {/snippet}
    ...
    <QDocsSection title="Navigation and links">
      {#snippet sectionDescription()}
        ...
        <code>href</code>
        for routes and external links. If not combined with <code>expandIconToggle</code>, clicking
        the header will not expand the content, but rather navigate to the specified route or link
        (making the use of <code>QExpansionItem</code> kind of useless).
      {/snippet}
    ...
    <QDocsSection title="Accessibility">
      {#snippet sectionDescription()}
        QExpansionItem includes accessibility features like ARIA labels and keyboard navigation. Use <code
          >toggleAriaLabel</code
        > to customize the accessibility label for the toggle button.
      {/snippet}
      ...
      <QList bordered separator>
        ...
        >
          <p>
            Getting started is easy! Install the package, import the components you need, and start
            building. Check our documentation for detailed examples and API references.
          </p>
        </QExpansionItem>
      </QList>
    </QDocsSection>
    ...
    <QDocsSection title="Complex example">
      {#snippet sectionDescription()}
        A comprehensive example combining multiple features: accordion grouping, custom icons, dense
        styling, and mixed content types.
      {/snippet}

      <QList bordered separator>
        <QExpansionItem label="Account Settings" icon="account_circle" name="settings-group" dense>
          <div class="q-pa-md">

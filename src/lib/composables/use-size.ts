...
export const sizes: Quaff.Size[] = ["none", "xs", "sm", "md", "lg", "xl"];

export const CssUnits: Quaff.CssUnit[] = [
  "px",
  "%",
  "em",
  "ex",
 ...
 */
export function isQuaffSize(size: number | string): size is Quaff.Size {
  return sizes.includes(size as Quaff.Size);
}

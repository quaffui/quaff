...
class KColors {
	...
	private static isValidRgb(r: ColorInput, g: ColorInput, b: ColorInput): boolean {
		return (
			isNumber(r) &&
			isNumber(g) &&
			isNumber(b) &&
  ...
  private static isValidHsl(h: ColorInput, s: ColorInput, l: ColorInput): boolean {
    return (
      isNumber(h) &&
      isNumber(s) &&
      isNumber(l) &&
  ...
  static rgbToHex(r: ColorInput, g: ColorInput, b: ColorInput): string {
    if(!KColors.isValidRgb(r,g,b)) {
      throw new Error(

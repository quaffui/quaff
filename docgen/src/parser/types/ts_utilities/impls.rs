...
use crate::{
    ...
    parser::{ParsedType, StandardType, TypeParser, UtilityTypeParser},
    resolver::{PathResolver, TypeRegistry},
};

use super::{
    UtilityKVKind, UtilityTKind, UtilityType,
    funcs::{can_remove_undefined, filter_undefined_or_never, is_standard_type},
    impl_utility_enum,
};
...
impl UtilityTypeParser for IdentifierReference<'_> {
    /// Parses the required type arguments and simplifies supported two-argument utilities.

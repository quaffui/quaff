...
use super::{FunctionType, Interface, InterfaceProperty, UtilityKVKind, UtilityTKind};
...
/// A named interface or type alias, retaining its arguments and parsed representation.
///
/// The dependency registry tracks any declarations needed by its hover definition.
#[derive(Debug, Clone)]
pub struct ReferenceType {
    ...
    /// The resolved type used for structural operations and rendering.

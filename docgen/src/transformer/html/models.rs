...
///
/// Text and attribute values are escaped by the builder. Only HTML assembled by
/// this module should be passed to [`HtmlItem::child_html`].
#[derive(Default)]
pub struct HtmlItem {
...
pub struct QApiPropInfo {
    /// The unformatted property name.
    pub name: String,
    /// The html content of the header, with the prop name, default and type definition
    pub header: String,
    /// The trusted, source-controlled JSDoc description of the property.
    ///
    /// This intentionally remains HTML-capable for backwards compatibility.

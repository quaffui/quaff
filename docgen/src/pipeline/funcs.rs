...
use super::models::Options;

/// Generates changed component docs and commits them only after all work succeeds.
...
/// Collects immediate component directories in deterministic order.
...
/// Maps component names and source paths to their containing component directories.
fn resolve_targets(
    root: &Path,
...
/// Resolves path aliases while retaining missing filenames inside existing components.
...
/// Collects component source files and generated outputs that have become obsolete.
fn collect_inputs(
    directories: &BTreeSet<PathBuf>,
